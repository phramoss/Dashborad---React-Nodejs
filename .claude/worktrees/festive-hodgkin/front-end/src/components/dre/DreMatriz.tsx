...
const DreClientRow = memo(function DreClientRow({
  ...
  return (
    <tr className="border-b border-[var(--line)] hover:bg-surface-light/10 transition-colors">
      <td
...
const DreContaRowComp = memo(function DreContaRowComp({
  ...
  return (
    <>
      <tr
        className="border-b border-[var(--line)] cursor-pointer hover:bg-surface-light/20 transition-colors select-none"
...
const DreLinhRow = memo(function DreLinhRow({
  ...
  return (
    <>
      <tr
        className={cn(
          'border-b border-[var(--line)] select-none transition-colors',
          hasContas && 'cursor-pointer hover:bg-surface-light/30',
          style.row,
          isSeparator && 'border-t border-[var(--line)]',
        )}
      ...
      >
        ...
        <td
          className={cn(TD_BASE, style.val, 'text-[11px] border-l border-[var(--line)]')}
      ...
      <table className="min-w-max w-full border-collapse text-sm">
        <thead className="sticky top-0 z-10 bg-[var(--table-header-bg)]">
          <tr className="border-b border-[var(--line)]">
            <th
              className={cn(thBase, 'text-left sticky left-0 z-20 bg-[var(--table-header-bg)]')}
              style={{ minWidth: MIN_LABEL_W }}
            >
              DRE
            </th>
            ...
            <th
              className={cn(thBase, 'border-l border-[var(--line)] text-brand')}
              style={{ minWidth: MIN_TOT_W }}
            >
              Total
            </th>
