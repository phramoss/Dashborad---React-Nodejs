            ...
            {periodos.map(p => {
              ...
              return (
                <td
                  key={p}
                  className={cn(
                    'px-2 py-1 text-right tabular-nums text-[11px] border-r border-[var(--line)]',
        ...
        <div className="overflow-x-auto overflow-y-auto" style={{ maxHeight: 293 }}>
          ...
          >
            <thead className="sticky top-0 z-10 bg-[var(--table-header-bg)]">
              <tr>
                <th style={{ width: COL_EXPAND, minWidth: COL_EXPAND, left: 0 }} className="sticky z-20 bg-[var(--table-header-bg)] border-b border-[var(--line)]" />
                <th
                ...
                <th
                  className="text-right px-2 py-1.5 text-text-muted font-medium border-b border-r border-[var(--line)] whitespace-nowrap"
                  style={{ minWidth: 90 }}
                >
                  Limite
                </th>
                {periodos.map(p => (
                  <th
                    key={p}
                    className="text-right px-2 py-1.5 text-text-muted font-medium border-b border-r border-[var(--line)] whitespace-nowrap cursor-pointer select-none hover:text-text-primary transition-colors"
                ...
                <th
                  className="text-right px-2 py-1.5 text-text-muted font-medium border-b border-[var(--line)] whitespace-nowrap cursor-pointer select-none hover:text-text-primary transition-colors"
                  style={{ minWidth: COL_VAL }}
            ...
            <tbody>
                ...
                return (
                  <Fragment key={item.value}>
                    <tr className={cn(
                      ...
                      <td className="text-right px-2 py-1.5 border-b border-r border-[var(--line)] whitespace-nowrap tabular-nums text-[11px]">
                      ...
                      {periodos.map(p => {
                        ...
                        return (
                          <td
                            key={p}
                            className={cn(
                              'px-2 py-1 text-right tabular-nums border-r border-[var(--line)]',
              ...
              <tr className="border-t-2 border-[var(--line)] font-semibold sticky bottom-0" style={{ background: 'var(--table-total-bg)' }}>
                ...
                {periodos.map(p => (
                  <td key={p} className="px-2 py-1.5 text-right tabular-nums text-text-primary border-r border-[var(--line)]">
