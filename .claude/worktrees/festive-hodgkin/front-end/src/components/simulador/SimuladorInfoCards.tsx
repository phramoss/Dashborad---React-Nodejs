...
export function CardSkeleton() {
  return (
    <div className="rounded-lg bg-surface border p-3 flex flex-col gap-1.5 min-h-[88px]" style={{ borderColor: 'var(--border)' }}>
...
export const InfoCard = memo(function InfoCard({
  ...
  return (
    <div className="rounded-lg border p-3 flex flex-col gap-0.5 min-w-0 h-full min-h-[88px] bg-surface" style={{ borderColor: 'var(--border)' }}>
...
export const LucroSlider = memo(function LucroSlider({ value, onChange, disabled, label }: LucroSliderProps) {
  ...
  return (
    <div className="rounded-lg border p-3 flex flex-col gap-1 min-w-0 h-full min-h-[88px] bg-surface" style={{ borderColor: 'var(--border)' }}>
