      ...
      <table className="min-w-max w-full border-collapse text-sm">
        <thead className="sticky top-0 z-10 bg-[var(--table-header-bg)]">
          <tr className="border-b border-[var(--line)]">
            <th
              className={cn(thLeft, 'sticky left-0 z-20 bg-[var(--table-header-bg)]')}
              style={{ minWidth: MTRZ_COL_MAT }}
            ...
            <th
              className={cn(thBase, 'sticky z-20 bg-[var(--table-header-bg)]')}
              style={{ minWidth: MTRZ_COL_BLOCO, left: MTRZ_COL_MAT }}
            >
              Nº Bloco
            </th>
        ...
        <tfoot className="sticky bottom-0 z-[5] bg-[var(--table-total-bg)] border-t-2 border-[var(--line)]">
          <tr>
            <td className={cn(MTRZ_TD_LEFT, 'sticky left-0 z-20 bg-[var(--table-total-bg)] font-semibold text-brand')} style={{ minWidth: MTRZ_COL_MAT }}>
              TOTAL
            </td>
            <td className={cn(MTRZ_TD_BASE, 'sticky z-20 bg-[var(--table-total-bg)]')} style={{ minWidth: MTRZ_COL_BLOCO, left: MTRZ_COL_MAT }}>—</td>
            {MATRIZ_COLS.map(c => (
