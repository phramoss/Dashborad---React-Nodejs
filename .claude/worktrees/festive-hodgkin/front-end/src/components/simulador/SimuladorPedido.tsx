    ...
    <Card noPadding>
      ...
      <div className="overflow-x-auto overflow-y-auto" style={{ maxHeight: maxHeight ?? 240 }}>
        <table className="min-w-max w-full border-collapse text-sm">
          ...
          <tfoot className="sticky bottom-0 bg-[var(--table-total-bg)] border-t-2 border-[var(--line)]">
            <tr>
      ...
      <div className="px-3 py-2 border-b border-surface-border/40">
        <div className="relative max-w-xs">
          ...
          <input
            ...
            className="w-full bg-surface border rounded-lg pl-7 pr-3 py-1.5 text-[11px] text-text-primary placeholder:text-text-muted/40 focus:outline-none focus:border-brand/50" style={{ borderColor: 'var(--border)' }}
          />
          {search && (
            <button
              onClick={() => setSearch('')}
