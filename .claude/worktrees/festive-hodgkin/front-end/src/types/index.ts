...
export interface FinanceiroBarItem {
  label: string
  total: number
}

export interface FinanceiroSemanal {
  dia:      string
  aReceber: number
  aPagar:   number
}

export interface FinanceiroSaldoBanco {
  codConta:     number
  nomeConta:    string
  saldoInicial: number
  saldoFinal:   number
...
export interface FinanceiroFluxoPonto {
  periodo:   number
  saldo:     number
  aReceber?: number
  aPagar?:   number
...
export interface FinanceiroFluxoCaixa {
  passado:    FinanceiroFluxoPonto[]
  futuro:     FinanceiroFluxoPonto[]
  saldoAtual: number
}

export interface FinanceiroFiltrosDisponiveis {
  moedas:   string[]
  empresas: { id: number; label: string }[]
